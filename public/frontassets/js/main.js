    ...
    t.on("load", function (a, o) {
        ...
        l.delay("500").fadeOut(2e3),
            ...
            e(".search-menu-toggle").on("click", function () {
                e(".mobile-search-form, .body-overlay").addClass("active"),
                    e("body").css({ overflow: "hidden" });
            }),
            e(".search-bar-close, .body-overlay").on("click", function () {
                e(".mobile-search-form, .body-overlay").removeClass("active"),
                    e("body").css({ overflow: "inherit" });
            }),
            e(".cat-menu-toggle").on("click", function () {
                e(".category-off-canvas-menu, .body-overlay").addClass(
                    "active"
                ),
                    e("body").css({ overflow: "hidden" });
            }),
            e(".cat-menu-close, .body-overlay").on("click", function () {
                e(".category-off-canvas-menu, .body-overlay").removeClass(
                    "active"
                ),
                    e("body").css({ overflow: "inherit" });
            }),
            e(".main-menu-toggle").on("click", function () {
                e(".main-off-canvas-menu, .body-overlay").addClass("active"),
                    e("body").css({ overflow: "hidden" });
            }),
            e(".main-menu-close, .body-overlay").on("click", function () {
                e(".main-off-canvas-menu, .body-overlay").removeClass("active"),
                    e("body").css({ overflow: "inherit" });
            }),
            e(".user-menu-toggle").on("click", function () {
                e(".user-off-canvas-menu, .body-overlay").addClass("active"),
                    e("body").css({ overflow: "hidden" });
            }),
            e(".user-menu-close, .body-overlay").on("click", function () {
                e(".user-off-canvas-menu, .body-overlay").removeClass("active"),
                    e("body").css({ overflow: "inherit" });
            }),
            e(".dashboard-menu-toggler").on("click", function () {
                e(".off--canvas-menu, .body-overlay").addClass("active"),
                    e("body").css({ overflow: "hidden" });
            }),
            e(".dashboard-menu-close, .body-overlay").on("click", function () {
                e(".off--canvas-menu, .body-overlay").removeClass("active"),
                    e("body").css({ overflow: "inherit" });
            }),
        ...
        t.on("scroll", function () {
            e(this).scrollTop() > 200
                ? (e(".header-menu-content").addClass("fixed-top"),
                  e("body").css(
                      "margin-top",
                      e(".header-menu-content").outerHeight() + "px"
                  ))
                : (e(".header-menu-content").removeClass("fixed-top"),
            ...
            e(L).length &&
                e(L).tagsinput({ tagClass: "badge badge-info", maxTags: 3 }),
            e(".curriculum-sidebar-list > .course-item-link").on(
                "click",
                function () {
                    var t = e(this);
                    t.addClass("active"),
                        t.siblings().removeClass("active"),
                        t.is(".active-resource")
                            ? e(".lecture-viewer-text-wrap").addClass("active")
                            : t.not(".active-resource") &&
                              e(".lecture-viewer-text-wrap").removeClass(
                                  "active"
                              );
                }
            ),
            ...
            s.on("click", ".ask-new-question-btn", function () {
                e(
                    ".new-question-wrap, .question-overview-result-wrap"
                ).addClass("active");
            }),
            s.on(
                "click",
            ...
            s.on("click", ".share-toggle", function () {
                var t = e(this);
                t.parent().find(".social-icons").toggleClass("social-active"),
                    t.toggleClass("share-toggle-active");
            }),
            e(".dropdown-btn").on("click", function (t) {
                t.preventDefault(),
                    e(this).next(".dropdown-menu-wrap").fadeToggle(100),
                    t.stopPropagation();
            }),
            s.on("click", function (t) {
                ...
                a === t.target ||
                    ...
                    e(".dropdown-menu-wrap").fadeOut(100);
            }),
            e(I).length &&
        ...
        for (
            var O = document.querySelectorAll(".payment-tab-toggle > input"),
                A = 0;
            A < O.length;
            A++
        )
        ...
        function E(e) {
            for (
                var t = document.querySelectorAll(".payment-tab"), a = 0;
                a < t.length;
                a++
            )
