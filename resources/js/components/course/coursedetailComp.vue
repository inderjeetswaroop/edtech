    ...
    created(){
        ...
        axios.get("/front-single-course-detail/"+this.courseId)
            .then((response) => {
                    ...
                    this.pageTitle = this.courseInfo.courseName
                    this.pageMtitle = this.courseInfo.courseName
                    this.pageMkeys = this.courseInfo.mkeywords
                    this.pageMdesc = this.courseInfo.mdescription
                })
