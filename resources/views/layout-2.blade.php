                    ...
                    <div class="tab-content-cls">
                        <div id="tab-1" class="tab-content active default">
                            <div class="product-slide-6 product-m no-arrow">
                                <proview-component></proview-component>
                                <proview-component></proview-component>
                                <proview-component></proview-component>
                                <proview-component></proview-component>
                                <proview-component></proview-component>
                ...
                <div class="blog-slide no-arrow">
                    <div >
                        <div class="blog-contain">
                            <div class="blog-img">
                                <img src="{{asset('assets')}}/images/layout-1/blog/1.jpg" alt="blog" class="img-fluid  w-100">
                            </div>
                    ...
                    <div>
                        <div class="blog-contain">
                            <div class="blog-img">
                                <img src="{{asset('assets')}}/images/layout-1/blog/2.jpg" alt="blog" class="img-fluid w-100 ">
                            </div>
                            <div class="blog-details">
                                <h4>Latest News Post</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur eleifend a massa rhoncus gravida.</p>
                    ...
                    <div>
                        <div class="blog-contain">
                            <div class="blog-img">
                                <img src="{{asset('assets')}}/images/layout-1/blog/3.jpg" alt="blog" class="img-fluid w-100 ">
                            </div>
                            <div class="blog-details">
                                <h4>Latest News Post</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur eleifend a massa rhoncus gravida.</p>
                ...
                <div class="slide-1 no-arrow">
                        ...
                        <div class="testimonial-contain">
                            <div class="media">
                                <div class="testimonial-img">
                                    <img src="{{asset('assets')}}/images/testimonial/1.jpg" class="img-fluid rounded-circle " alt="testimonial">
                                </div>
                                <div class="media-body">
                                    <h5>mark jecno</h5>
                    ...
                    <div>
                        <div class="testimonial-contain">
                            <div class="media">
                                <div class="testimonial-img">
                                    <img src="{{asset('assets')}}/images/testimonial/2.jpg" class="img-fluid rounded-circle  " alt="testimonial">
                                </div>
                                <div class="media-body">
                                    <h5>mark jecno</h5>
                                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
                    ...
                    <div>
                        <div class="testimonial-contain">
                            <div class="media">
                                <div class="testimonial-img">
                                    <img src="{{asset('assets')}}/images/testimonial/3.jpg" class="img-fluid rounded-circle  " alt="testimonial">
                                </div>
                                <div class="media-body">
                                    <h5>mark jecno</h5>
                                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
    ...
    <div class="newsletter bg-transparent">
        ...
        <div class="subscribe-block">
            <div class="input-group ">
                ...
                <input type="text" placeholder="ENTER YOUR EMAIL{{asset('assets')}}{{asset('assets')}}" >
            </div>
